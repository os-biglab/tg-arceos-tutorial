...
/// ArceOS helloworld multi-architecture build & run tool
#[derive(Parser)]
#[command(name = "xtask", about = "Build and run arceos-helloworld on different architectures")]
struct Cli {
    #[command(subcommand)]
    command: Cmd,
}
